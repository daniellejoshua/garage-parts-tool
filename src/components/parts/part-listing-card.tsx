...
export function PartListingCard({
  ...
  return (
    <Card className={cn("shadow-sm", compact && "gap-3 py-3")}>
      <CardHeader className={cn("border-b border-border bg-muted/20 pb-4", compact && "px-4 pb-3")}>
      ...
      <CardContent className={cn("space-y-4", compact && "space-y-3 px-4")}>
        <div>
        ...
        <div className={cn("relative aspect-[16/10] overflow-hidden rounded-lg border border-border bg-muted/35", compact && "max-h-[250px]")}>
          {selectedStaged ? (
        ...
        <div className={cn("grid grid-cols-1 gap-x-4 gap-y-3 border-y border-border py-4 sm:grid-cols-2", compact && "gap-y-2.5 py-3")}>
        ...
        <div className={cn("grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2", compact && "gap-y-2.5")}>
